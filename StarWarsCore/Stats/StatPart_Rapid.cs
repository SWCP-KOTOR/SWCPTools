        ...
        if (t is Pawn pawn)
        {
            ...
            if (pawn.apparel != null)
            {
                ...
                foreach (Apparel apparel in legendaryApparel)
                {
                    ...
                    {
                        count += LegendaryEffectGameTracker.EffectsDict[apparel].Count(eff => eff == SWCPDefOf.SWCP_VATSLegendaryEffect_Rapid);
                    }
                }
            }
            ...
            if (pawn.equipment != null && pawn.equipment.Primary != null)
            {
                ...
                {
                    count += LegendaryEffectGameTracker.EffectsDict[pawn.equipment.Primary].Count(eff => eff == SWCPDefOf.SWCP_VATSLegendaryEffect_Rapid);
                }
            }
            return count;
        }
