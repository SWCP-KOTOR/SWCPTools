...
public class SWCP_Settings : ModSettings
{
    ...
    public void DoWindowContents(Rect wrect)
    {
        ...
        {
            //30
            if (options.ButtonText("SWCP_VATS_Settings_Reset".Translate()))
            {
            ...
            //22
            options.Label("SWCP_VATS_Settings_FlatHitChanceBoost".Translate(FlatHitChanceBoost.ToString("F5")), tooltip: "SWCP_VATS_Settings_FlatHitChanceBoost_Mouseover".Translate());
            //30
            ...
            //30
            options.CheckboxLabeled("SWCP_VATS_Settings_EnableSlowDownTime".Translate(), ref EnableSlowDownTime);
            //12
            options.Gap();
            //30

            options.CheckboxLabeled("SWCP_VATS_Settings_EnableZoom".Translate(), ref EnableZoom);
            //12
            options.Gap();

            //22
            options.Label("SWCP_VATS_Settings_ZoomTimeout".Translate(ZoomTimeout));
            //22
            ...
            //22
            options.Label("SWCP_VATS_Settings_CooldownTicks".Translate(CooldownTicks));
            //22
            ...
            //22
            options.Label("SWCP_VATS_Settings_BodyPartMultipliers".Translate());
